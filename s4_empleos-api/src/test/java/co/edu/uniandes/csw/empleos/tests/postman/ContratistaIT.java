...
import co.edu.uniandes.csw.empleos.resources.ContratistaResource;
...
public class ContratistaIT {
    
    
    private static final String COLLECTION = "ContratistaResourceTest.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s4_empleos-api.war")//War del modulo api
                ...
                .addPackage(ContratistaResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(ContratistaDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
